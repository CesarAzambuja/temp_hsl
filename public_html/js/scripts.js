...
function maternidade(){
    ...
    <img src="http://hslsantos.com.br/images/maternidade-sao-lucas.jpg" alt="">
    ...
    <div class="button-flex">
        <a href="http://hslsantos.com.br/images/relacao-de-roupas.pdf" target="_blank" class="btn btn-close">Veja o que levar</a>
        <button onclick="closeModal()" class="btn btn-close">Fechar</button>
    </div>
    `
}
...
function visitante(){
    ...
    <div class="button-flex">
        <a href="http://hslsantos.com.br/images/mais-info.pdf" target="_blank" class="btn btn-close">Mais informações</a>
        <button onclick="closeModal()" class="btn btn-close">Fechar</button>
    </div>
    `
}
...
function rotinaInternacao(){
    ...
    <div class="button-flex">
        <a href="http://hslsantos.com.br/images/hospitalar.pdf" target="_blank" class="btn btn-close">Mais informações</a>
        <button onclick="closeModal()" class="btn btn-close">Fechar</button>
    </div>
    `
}
